...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" className="shrink-0 text-black dark:text-white size-[17px] sm:size-[15px]" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 4V20" className="transition-opacity duration-150 group-aria-expanded/accordion-trigger:opacity-0" />
          <path d="M20 12H4" />
        </svg>
      </AccordionPrimitive.Trigger>
