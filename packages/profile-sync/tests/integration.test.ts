...
import { detectBrowserProfiles } from "../src/browser/detector.js";
import { extractAllProfileCookies, extractProfileCookies } from "../src/extract.js";
...
describe("extractProfileCookies", () => {
  ...
  it(
    "returns cookies with correct shape",
    async () => {
      const profiles = detectBrowserProfiles();
      const firstProfile = profiles[0]!;
