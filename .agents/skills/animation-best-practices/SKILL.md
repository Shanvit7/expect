...
For deeper context on animation theory, CSS animations, Framer Motion, SVG animation, performance, accessibility, and real-world walkthroughs, see **[reference/README.md](reference/README.md)**.
...
**Rule:** UI animations should stay under 300ms. Snappy easing curve: `cubic-bezier(0.32, 0.72, 0, 1)`.
...
**Resources:** [easings.co](https://easings.co/)
...
Blur bridges visual gaps between states, tricking the eye into seeing smoother transitions. Keep under 20px, especially on Safari.
